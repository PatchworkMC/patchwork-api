...
public class EntityEvents implements ModInitializer {
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onInteractEntity")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onLivingDeath")
	public static boolean onLivingDeath(LivingEntity entity, DamageSource src) {
		return MinecraftForge.EVENT_BUS.post(new LivingDeathEvent(entity, src));
	}

	@GodClass("net.minecraftforge.common.ForgeHooks:onLivingUpdate")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onLivingAttack")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onPlayerAttack")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onLivingSetAttackTarget")
	public static void onLivingSetAttackTarget(LivingEntity entity, LivingEntity target) {
		MinecraftForge.EVENT_BUS.post(new LivingSetAttackTargetEvent(entity, target));
	}

	@GodClass("net.minecraftforge.common.ForgeHooks:onLivingHurt")
	...
	@Nullable
	@GodClass("net.minecraftforge.common.ForgeHooks:onLivingFall")
	...
	@GodClass("net.minecraftforge.event.ForgeEventFactory:onPlayerFall")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onLivingDamage")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onLivingDrops")
	...
	@GodClass("net.minecraftforge.event.ForgeEventFactory:canEntitySpawn")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:canEntitySpawn")
	...
	@GodClass("net.minecraftforge.event.ForgeEventFactory:canEntitySpawnSpawner")
	...
	@GodClass("net.minecraftforge.event.ForgeEventFactory:doSpecialSpawn")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onPlayerAttackTarget")
	...
	@GodClass("net.minecraftforge.event.ForgeEventFactory:onAnimalTame")
	...
	@GodClass("net.minecraftforge.event.ForgeEventFactory:onProjectileImpact")
	...
	@GodClass("net.minecraftforge.common.ForgeHooks:onTravelToDimension")

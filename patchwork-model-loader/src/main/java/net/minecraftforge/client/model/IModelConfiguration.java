...
public interface IModelConfiguration {
	...
	/**
	 * Resolves the final texture name, taking into account texture aliases and
	 * replacements.
	 * @param name The name of a texture channel.
	...
	/**
	 * Gets the vanilla camera transforms data. Do not use for non-vanilla code. For
	 * general usage, prefer getCombinedState.
	 */
	@Deprecated
	 ...
	 * @param fallback A boolean specifying the default visibility if an override
	 *                 isn't found in the model data.
	...
	/**
	 * Queries the visibility information for the model parts. Same as above, but

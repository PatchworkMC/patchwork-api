...
public class MixinSpecialRecipeSerializer implements ExtendedForgeRegistryEntry<RecipeSerializer> {
	@Unique
	...
	public Identifier getRegistryName() {
		SpecialRecipeSerializer<?> specialRecipeSerializer = (SpecialRecipeSerializer<?>) (Object) this;

		return Identifiers.getOrFallback(Registry.RECIPE_SERIALIZER, specialRecipeSerializer, registryName);
	}
